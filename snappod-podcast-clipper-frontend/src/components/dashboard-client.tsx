                ...
                <TabsContent value="upload">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Upload your video or video to generate clips
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Dropzone 
                            ...
                            {uploadedFiles.length > 0 &&  (
                                <div className="pt-6">
                                    ...
                                    <div className="max-h-[300px] overflow-auto rounded-md border"></div>
                                    <Table>
                                        <TableHeader>
                                            <TableRow>
                ...
                <TabsContent value="my-clips">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                View & manage your generated clips here. Processing may take a
                                few minutes.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
